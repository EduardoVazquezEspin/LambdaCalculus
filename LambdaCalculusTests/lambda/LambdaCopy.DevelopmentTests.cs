...
//        Assert.True(copy.IsWellFormatted());
//        Assert.That(copy.ToString(), Is.EqualTo(expression.ToString()));
//        Assert.That(expression.Definition, Is.EqualTo((expression.Expression as Lambda)!.Expression));
//        Assert.That(copy.Definition, Is.EqualTo((copy.Expression as Lambda)!.Expression));
...
//        Assert.True(copy.IsWellFormatted());
//        Assert.That(copy.ToString(), Is.EqualTo(expression.ToString()));
//        Assert.That(childLambda.Definition, Is.EqualTo(childLambda.Expression));
//        Assert.That(childCopy.Definition, Is.EqualTo(childCopy.Expression));
